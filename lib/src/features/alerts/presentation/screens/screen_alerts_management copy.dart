...
class AlertsManagementScreenCopy extends ConsumerStatefulWidget {
  const AlertsManagementScreenCopy({super.key});
...
class _AlertsManagementScreenState
    extends ConsumerState<AlertsManagementScreenCopy> {
